...
Suppose I start with the axiom that *any thing cannot have come from nothing*, or rather, nothing (i.e., imagine some void, zero, or naught)cannot in any way yield an entity other than the void itself, maybe existing at some other time, or dimension. It's easy to think about this as the conservation of matter-energy, but I believe the concept can be extended to concepts, and conceptions.
